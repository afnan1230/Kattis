 ...
 public class ProductListTester
{
	...
	public static void main(String[] args)
	{
		...
		list.addLast(new Product("sushi",12.42,3));
		...
		list.clear();
		list.add(new Product("spinach", 3.15, 1));
		list.addLast(new Product("cucumber", 1.22, 2));
		list.add(new Product("sausage", 4.25, 1));
		
		System.out.println("\n\nSECTION 3  :");
		System.out.println("testing add(index)"); 
		System.out.println(list);
		list.add(0,new Product("pickles",2.50,1));
		list.add(4,new Product("ice cream",5.79,5)); // adding next available index
		System.out.println("List after ice cream " + list.size() + "\n" + list);
		list.add(3,new Product("caramel sauce",3.15,2));
		System.out.println("List contains " + list.size() + " elements");
		System.out.println(list);
		try
		{	
			System.out.println("Attempt to add at index 7");
			list.add(7,new Product("fail",1,1));
		}
		catch(Exception e)
		{
		...
		System.out.println("Index of spinach: " + list.indexOf("spinach"));
		System.out.println("\nRemoving " + list.remove(0));
		System.out.println("Removing " + list.remove(2));
		System.out.println("Removing " + list.remove(3));
		System.out.println();
		try
		{
			System.out.println("Attempt to remove index 3");
			list.remove(3);
		}
		catch(Exception e)
		{
		...
		try
		{
			System.out.println("Attempt to remove index -1");
			list.remove(-1);
		}
		catch(Exception e)
		{
		...
		list.set(2,new Product("alfredo sauce",4.26,2));
		list.set(1,new Product("mango",1.80,2));
		System.out.println(list);
		try
		{
			System.out.println("Attempt to set at index 3");
			list.set(3,new Product("fail",1,1));
		}
		catch(Exception e)
		{
			System.out.println(e.getMessage());
		...
		System.out.println ("\nAdding last");
		list.addLast(new Product("spam",4.15,100));
		System.out.println (list);
		...
		System.out.println ("\nSECTION 7: Testing Iterators");
		System.out.println ("Size before iterator: " + list.size());
		System.out.println ("\nList with foreach:");
		for(Product p: list)
		...
		System.out.println ("Size after iterator: " + list.size());
		
		System.out.println ("\nSECTION 8: Post-iterator check");
		System.out.println (list);
		System.out.println (list.size());
		System.out.println (list.getFirst());
		System.out.println (list.getLast());
		System.out.println (list.indexOf("tomato sauce"));
